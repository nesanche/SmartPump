...
public class RegisterFragment extends Fragment {
    ...
    public boolean validateFields() {
        return validateFieldsAreNotEmpty() && checkUsername()
                && validatePasswords();
    }
    ...
    public boolean validateFieldsAreNotEmpty() {
        if (StringUtils.isEmpty(etFirstName.getText().toString())) {
            Toast.makeText(getActivity(),
                    getResources().getString(R.string.es_firstname_empty),
        ...
        if (StringUtils.isEmpty(etLastName.getText().toString())) {
            Toast.makeText(getActivity(),
                    getResources().getString(R.string.es_lastname_empty),
                    Toast.LENGTH_LONG).show();
        ...
        if (StringUtils.isEmpty(etUserName.getText().toString())) {
            Toast.makeText(getActivity(),
                    getResources().getString(R.string.es_username_empty),
                    Toast.LENGTH_LONG).show();
        ...
        if (StringUtils.isEmpty(etPassword.getText().toString())) {
            Toast.makeText(getActivity(),
                    getResources().getString(R.string.es_password_empty),
                    Toast.LENGTH_LONG).show();
        ...
        if (StringUtils.isEmpty(etRepeatPassword.getText().toString())) {
            Toast.makeText(
                    getActivity(),
                    getResources().getString(R.string.es_repeat_password_empty),
                    Toast.LENGTH_LONG).show();
        ...
        if (StringUtils.isEmpty(etMail.getText().toString())) {
            Toast.makeText(getActivity(),
                    getResources().getString(R.string.es_mail_empty),
                    Toast.LENGTH_LONG).show();
            etMail.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_mail,
    ...
    private boolean validatePasswords() {
        if (!passMatchPattern()) {
            Toast.makeText(getActivity(),
                    getResources().getString(R.string.es_pass_format),
                    Toast.LENGTH_LONG).show();
            etPassword.setCompoundDrawablesWithIntrinsicBounds(
                    R.drawable.ic_pass, 0, R.drawable.ic_wrong, 0);
            etRepeatPassword.setCompoundDrawablesWithIntrinsicBounds(
        ...
        if (!passwordsMatch()) {
            Toast.makeText(getActivity(),
                    getResources().getString(R.string.es_password_dont_match),
                    Toast.LENGTH_LONG).show();
            etPassword.setCompoundDrawablesWithIntrinsicBounds(
                    R.drawable.ic_pass, 0, R.drawable.ic_wrong, 0);
            etRepeatPassword.setCompoundDrawablesWithIntrinsicBounds(
