...
public class EnterUserFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnNext.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                user.setRole(new UserRole(3, "Patient"));
                EntityManager.getInstance().getPatient().setUser(user);
    ...
    private void setCurrentItem() {
        ((RegisterActivity) getActivity()).setCurrentItem(3);
    }
     ...
     *
     */
    class VerifyUserName extends AsyncTask<String, Void, Boolean> {
        @Override
        ...
        protected Boolean doInBackground(String... username) {
            ...
            return requestManager.checkUsernameAvailability(context, username[0]);
        }
