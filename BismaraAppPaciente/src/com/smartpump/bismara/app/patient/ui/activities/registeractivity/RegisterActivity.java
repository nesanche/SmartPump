package com.smartpump.bismara.app.patient.ui.activities.registeractivity;
...
import com.smartpump.bismara.app.patient.adapter.TabsRegisterFlowAdapter;
...
public class RegisterActivity extends FragmentActivity implements TabListener {
    ...
    private String[] tabs = { "Name", "Phone", "User", "Doctor", "Pump", "VerificationPin" };
